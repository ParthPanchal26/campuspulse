...

                        {
                            events.slice(0, 3).map((event) => (
                                ...
                                <div key={event.id} className="w-[25rem] m-2 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    {
                                        token
                                            ? <button className="inline-flex mt-2 sm:mt-2 items-center px-6 py-3 text-sm font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none transition-all hover:px-9">
                                                View Event
