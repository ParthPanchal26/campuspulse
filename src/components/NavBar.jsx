    ...
    return (
        <nav className="bg-white border-b-1 border-gray-500 dark:bg-gray-900 fixed top-0 left-0 w-full z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div onClick={() => setIsNavOpen(!isNavOpen)} className="flex md:order-2 items-center mr-4 md:space-x-0 rtl:space-x-reverse md:hidden">
            ...
            </div>
            {
                isNavOpen && isNavOpen
                    ? <div className="flex flex-col items-center py-3">
                        <ul className="flex items-center flex-col font-medium p-4 md:p-0 mt-2 border-gray-100 rounded-md bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
